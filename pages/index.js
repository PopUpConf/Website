      ...
      <div className="home">
        <Helmet
          meta={[
            ...
            { name: 'og:title', content: config.siteSummary, prefix: 'og: http://ogp.me/ns#' },
            { name: 'og:description', content: config.siteDescription, prefix: 'og: http://ogp.me/ns#' },
            { name: 'og:type', content: 'website', prefix: 'og: http://ogp.me/ns#' },
            { name: 'og:image', content: `http://${config.siteHost}${prefixLink(OpenGraphImage)}`, prefix: 'og: http://ogp.me/ns#' },
            { name: 'og:url', content: `http://${config.siteHost}/`, prefix: 'og: http://ogp.me/ns#' },
